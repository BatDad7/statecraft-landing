...
import { AlertCircle, ChevronRight, Terminal, ShieldCheck, Check, Power, Zap, ClipboardCheck, Quote } from "lucide-react";
...
export default function Home() {
  ...
  const controlFeatures = [
    ...
    },
    {
      ...
      title: "God Controls",
      text: "Inject crises, freeze assets, or sanction countries instantly if students get out of hand.",
    },
    {
  ...
  return (
    <div className="bg-slate-900 text-white min-h-screen font-sans">
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            >
              <motion.button
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 rounded-md bg-brand-blue px-10 py-5 text-lg font-bold text-white transition-all hover:bg-blue-700 hover:shadow-[0_0_20px_rgba(37,99,235,0.4)]"
              >
            ...
            <motion.div
              ...
              className="flex flex-wrap justify-center gap-x-8 gap-y-4 px-4"
            >
              {techSpecs.map((spec, i) => (
                <div key={i} className="flex items-center gap-2">
                  <Check className="h-4 w-4 text-slate-500" />
                  <span className="text-[12px] font-medium text-slate-400 uppercase tracking-widest">{spec}</span>
                </div>
              ))}
            </motion.div>
          </div>
      ...
      {/* God Controls Section */}
      <section id="demo" className="py-24 px-4 bg-slate-900 border-t border-slate-800 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-serif font-black uppercase italic mb-4">
              Total <span className="text-brand-blue">Classroom Control.</span>
            </h2>
            <p className="text-2xl font-bold text-slate-400">You are the Game Master. They are the players.</p>
          </div>
